...
SELECT 'RECEIVED', 'Recibido', 'slate', 0 FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM order_statuses WHERE code = 'RECEIVED');
INSERT INTO order_statuses (code, name, color, is_final)
SELECT 'READY_FOR_DELIVERY', 'Listo para entregar', 'green', 0 FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM order_statuses WHERE code = 'READY_FOR_DELIVERY');
INSERT INTO order_statuses (code, name, color, is_final)
SELECT 'WARRANTY', 'En garantía', 'amber', 0 FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM order_statuses WHERE code = 'WARRANTY');
INSERT INTO order_statuses (code, name, color, is_final)
SELECT 'CANCELED', 'Cancelado', 'red', 1 FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM order_statuses WHERE code = 'CANCELED');
INSERT INTO permissions (code, name, module)
SELECT 'orders.manage', 'Gestionar órdenes', 'orders' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM permissions WHERE code = 'orders.manage');
INSERT INTO permissions (code, name, module)
SELECT 'payments.manage', 'Gestionar pagos', 'payments' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM permissions WHERE code = 'payments.manage');
INSERT INTO permissions (code, name, module)
SELECT 'invoices.manage', 'Gestionar facturas', 'invoices' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM permissions WHERE code = 'invoices.manage');
INSERT INTO permissions (code, name, module)
SELECT 'cash.manage', 'Gestionar caja', 'cash' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM permissions WHERE code = 'cash.manage');
INSERT INTO permissions (code, name, module)
SELECT 'deliveries.manage', 'Gestionar entregas', 'deliveries' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM permissions WHERE code = 'deliveries.manage');
